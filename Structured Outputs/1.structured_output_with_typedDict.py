...
class Review_Annotated(TypedDict):
    productName: Annotated[str,'Derived name of the product being reviewed']
    key_themes: Annotated[list[str],"Write down all the key themes mentioned in the review"]
    summary: Annotated[str,"Summary of the review made about the product"]
    # sentiment:Annotated[str,"Overall user sentiment, Positive, negative or neutral"]
    sentiment:Annotated[Literal['pos','neg','neu'],"Overall user sentiment, Positive, negative or neutral"]
    pros: Annotated[Optional[list[str]],"Any pros mentioned about the product in the review"]
    cons: Annotated[Optional[list[str]],"Any cons mentioned about the product in the review"]
...
structured_model_annotated = model.with_structured_output(Review_Annotated)
